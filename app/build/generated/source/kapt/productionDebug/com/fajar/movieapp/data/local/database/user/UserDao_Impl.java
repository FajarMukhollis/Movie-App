...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `user` (`userId`,`username`,`email`,`password`,`fullName`,`dateOfBirth`,`address`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, UserEntity value) {
        ...
        if (value.getDateOfBirth() == null) {
          ...
          stmt.bindString(6, value.getDateOfBirth());
        }
    ...
    this.__updateAdapterOfUserEntity = new EntityDeletionOrUpdateAdapter<UserEntity>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `user` SET `userId` = ?,`username` = ?,`email` = ?,`password` = ?,`fullName` = ?,`dateOfBirth` = ?,`address` = ? WHERE `userId` = ?";
      }
  ...
  @Override
  public Object updateUser(final UserEntity user,
  ...
  @Override
  public Object getIfUserExists(final String username,
      final Continuation<? super Boolean> continuation) {
    final String _sql = "SELECT EXISTS(SELECT * FROM user WHERE username = ?)";
  ...
  @Override
  public Object getUserById(final long id, final Continuation<? super UserEntity> continuation) {
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpUserId,_tmpUsername,_tmpEmail,_tmpPassword,_tmpFullName,_tmpDateOfBirth,_tmpAddress);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object validateUserLogin(final String username, final String password,
      final Continuation<? super Boolean> continuation) {
    final String _sql = "SELECT EXISTS(SELECT * FROM user WHERE username = ? AND password = ?)";
